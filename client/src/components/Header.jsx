...
const Header = () => {
  return (
    <motion.div className='flex flex-col justify-center items-center
        ...
        mt-10 text-center'>Turn text to 
        ...
        transition={{delay: 0.6, duration: 0.8}}
          >Unleash your creativity with AI. Turn tour imaginatioon into 
        visual art in seconds - just type, and watch the magic 
        happen.</motion.p>

        <motion.button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex 
